...
const orientationScreens = [
  {
    image: require('./Images/onboarding_test.png'),
    heading: 'Identify',
    copy: 'Qi Identity is my digital passport'
  },
  {
  ...
  },
  {
    ...
    heading: 'Access',
    copy: 'Qi Access magically logs me in without usernames & passwords'
  },
  {
    image: require('./Images/share.png'),
    heading: 'Secure',
    copy: 'Qi Safe secures my personal information under my control'
  },
  {
    image: require('./Images/rewards.png'),
    heading: 'Rewards',
    copy: 'Qi Rewards give me Thanks Points and personalised offers'
  }
];
...
class Lifekeyrn extends Component {
  ...
  _nativeEventTokenRefreshed(token) {
    ConsentUser.setToken(token).catch(Logger.firebase);
  }
        ...
        renderScene={(route, navigator) => {
          ...
          return (
            ...
            >
              ...
              {React.createElement(route.scene, {
